...
import au.org.intersect.dms.core.errors.JobCancelledException;
...
public class JobTracker
{
    ...
    private JobCancelledException cancelJob;

    private JobListener jobListener;

    private long timeStamp;

    public JobTracker(JobListener jobListener, Long jobId)
    {
    ...
    public void jobException(Exception e)
    {
        ...
        boolean nonCancelled = cancelJob == null;
        jobListener.jobEnd(new JobFinished(jobId, nonCancelled ? JobStatus.ABORTED : JobStatus.CANCELLED,
                nonCancelled ? e : null));
    }
    ...
    {
        cancelJob = new JobCancelledException();
    }

    public boolean isCancelled()
    {
        return cancelJob != null;
    }
