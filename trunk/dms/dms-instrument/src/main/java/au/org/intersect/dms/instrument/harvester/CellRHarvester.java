...
/**
 * Implements the harvest profile for olympus-CellR. It harvest a mtb file and nothing else. 
 * 
 * @version $Rev: 29 $
 */
public class CellRHarvester implements InstrumentHarvester
{
    @Autowired
    ...
    public FileHarvester getHarvesterFor(String path)
    {
        if (path.endsWith(".mtb"))
        {
            ...
            return new CellRMtbHarvester(executorService, urlCreator.getUrl(toDir), this);
        }
        else
        {
            return null;
