...
public class ContextLauncher
{
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            MetadataRepository service = context.getBean(MetadataRepository.class);
            DbDataset.indexDbDatasets(DbDataset.findAllDbDatasets());
            LOGGER.info("Please wait to finish then press enter to exit....");
            System.in.read();
        }
        catch (Exception e)
        {
