...
{
    private static final Logger LOGGER = LoggerFactory.getLogger(BookingSystemTester.class);
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            BookingGatewayMetadataService bookingSystem = context.getBean(BookingGatewayMetadataService.class);
            String metadata = bookingSystem.getMetadata(1L, 101L, "http://localhost/test");
