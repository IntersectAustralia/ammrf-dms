...
import au.org.intersect.dms.service.JobMetadataIngestor;
 ...
 * 
 */
public class JobMetadataIngestorImpl implements JobMetadataIngestor
{

    private static final long SLEEP = 30000L;

    private static final Logger LOGGER = LoggerFactory.getLogger(JobMetadataIngestorImpl.class);
