...
/**
 * Returns the instrument profile for a given profileId
 *
 * @version $Rev: 29 $
 */
public interface InstrumentHarvesterFactory
{
    InstrumentHarvester makeInstrumentHarvester(InstrumentProfile profile);
}
