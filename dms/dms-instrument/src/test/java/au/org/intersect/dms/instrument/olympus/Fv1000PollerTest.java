...
public class Fv1000PollerTest
{

    private static final String DATASET1_PATH = "/testuser1/dataset1";

    private static final String DATASET1_URL = "ftp://localhost" + DATASET1_PATH + "/test.oif";
    ...
    public void setUp() throws Exception
    {
        ...
        datasetFiles.add(new FileInfo(FileType.FILE, "/testuser1/dataset1/test.oif", "test.oif", 10L, date));
        datasetFiles.add(new FileInfo(FileType.DIRECTORY, "/testuser1/dataset1/test.oif.files", "test.oif.files", 0L,
                date));
    }
    ...
    public void oneNewDatasetOneUser()
    {
        ...
        List<DatasetParams> expectedDatasets = new LinkedList<DatasetParams>();
        DatasetParams expectedDataset = new DatasetParams("testuser1", DATASET1_PATH + "/test.oif",
                dataset1.getModificationDate(), InstrumentProfile.OLYMPUS_FV1000);
        expectedDataset.setFromFiles(Arrays.asList(expectedDataset.getAbsolutePath(), expectedDataset.getAbsolutePath()
                + ".files"));
