<xsl:stylesheet version="1.0"
    ...
    xmlns:i="http://www.acmm.sydney.edu.au/schemata/olympusfv1000"
    xmlns:dmsutil="http://www.acmm.sydney.edu.au/au.org.intersect.dms.util"
    exclude-result-prefixes="dmsutil">

<xsl:output method="html" encoding="UTF-8"/>
<xsl:variable name="mapping" select="document('olympus_fv1000-mapping.xml')/mapping"/>
<xsl:template match="/">
	<style>
...
<!-- BEGIN CONTENT -->
	<xsl:for-each select="//i:olympusFv1000/i:section">
